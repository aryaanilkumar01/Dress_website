...
<div style={{ width: '100%', height: '70vh', backgroundColor: "orange" }} >
      ...
      <h2 style={{textAlign:'center'}}>womens</h2>
          <div className='col-lg-3'>
              ...
              <Card.Body>
                <Card.Title>Casual Frocks</Card.Title>
                <Card.Text>
                <p style={{fontSize:'20px'}}><b>$800.00</b></p>
                </Card.Text>
                <div className='d-flex justify-content-between '>
                  <Button  variant="primary">Buy Now</Button>
                  <i style={{color:'red'}} class="fa-solid fa-heart mt-2 me-3"></i>
                </div>
              </Card.Body>
            </Card>
              </div>
      ...
      <h2 style={{textAlign:'center'}}>Gents</h2>
          ...
          <div className='col-lg-3'>
              ...
              <Card.Body>
                <Card.Title>Shirt & Mundu</Card.Title>
                <Card.Text>
                <p style={{fontSize:'20px'}}><b>$800.00</b></p>
                </Card.Text>
                <div className='d-flex justify-content-between'>
      ...
      <h2 style={{textAlign:'center'}}>Latest Collections</h2>
          <div className='col-lg-3'>
              ...
              <Card.Body>
                <Card.Title>Bodycon dress</Card.Title>
                <Card.Text>
          ...
          <div className='col-lg-3'>
              ...
              <Card.Body>
                <Card.Title>Shirts & Pants</Card.Title>
                <Card.Text>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
          ...
          <div className='col-lg-3'>
              ...
              <Card.Body>
                <Card.Title>Baby girl dress</Card.Title>
                <Card.Text>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
          ...
          <div className='col-lg-3'>
              ...
              <Card.Body>
                <Card.Title>Casual Dress</Card.Title>
                <Card.Text>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
